...
export function CreateEventForm({ onSubmit, onClear }: CreateEventFormProps) {
  ...
  return (
    <Surface variant="secondary" className="rounded-2xl p-5 m-2">
      <Form
        key={formKey}
        className="flex w-full flex-col gap-4 my-2 px-2"
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          ...
          <DateField className="flex-1" name="date" isRequired>
            <Label>Data</Label>
            <DateField.Group>
              <DateField.Input>
        ...
        >
          ...
          <TextArea placeholder="Descreva o evento, palestrantes, programação..." rows={3} />
          <FieldError />
        </TextField>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          ...
          >
            <Label>Vagas</Label>
            <Input placeholder="Ex: 100" min={1} max={9999} />
            <FieldError />
          </TextField>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          <div className="flex flex-col gap-1.5 flex-1">
            ...
            <Select name="curso" className="w-full" placeholder="Selecione um curso">
              <Select.Trigger>
                <Select.Value />
                <Select.Indicator />
              </Select.Trigger>
          ...
          <div className="flex flex-col gap-1.5 sm:w-44">
            ...
            <Select name="turno" className="w-full" placeholder="Selecione um turno">
              <Select.Trigger>
                <Select.Value />
                <Select.Indicator />
              </Select.Trigger>
        ...
        <div className="flex justify-end gap-2 pt-2">
          <Button type="button" variant="outline" onPress={handleClear}>
            Limpar
          </Button>
