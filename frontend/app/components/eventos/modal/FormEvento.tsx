...
// ── Fora do FormEvento — evita recriação a cada render ──────────────────────
...
export function FormEvento({ inicial, onSalvar, onCancelar }: FormEventoProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex gap-3 pt-2">
        ...
        >
          {loading ? "Salvando..." : inicial?.id ? "Salvar alterações" : "Criar evento"}
        </button>
      </div>
    </form>
  );
